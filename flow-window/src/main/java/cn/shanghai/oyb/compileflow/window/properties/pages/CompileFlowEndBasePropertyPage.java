 ...
 * @author ouyubin
 */
public class CompileFlowEndBasePropertyPage extends CompileFlowElementBasePropertyPage {

    private static final Logger LOG = Logger.getInstance(CompileFlowEndBasePropertyPage.class);
    ...
    public CompileFlowEndBasePropertyPage() {
        super();
    }
    ...
    public void createControl(JComponent parent) {
        ...
        JLabel titleLabel = new JLabel("结束 «End»", CompileFlowImages.END_IMAGE(), SwingConstants.LEFT);
