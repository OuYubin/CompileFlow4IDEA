 ...
 * @author ouyubin
 */
public class CompileFlowContinueBasePropertyPage extends CompileFlowElementBasePropertyPage {

    private static final Logger LOG = Logger.getInstance(CompileFlowContinueBasePropertyPage.class);
    ...
    public CompileFlowContinueBasePropertyPage() {
        super();
    }
    ...
    public void createControl(JComponent parent) {
        ...
        JLabel titleLabel = new JLabel("继续 «Continue»", CompileFlowImages.CONTINUE_IMAGE(), SwingConstants.LEFT);
