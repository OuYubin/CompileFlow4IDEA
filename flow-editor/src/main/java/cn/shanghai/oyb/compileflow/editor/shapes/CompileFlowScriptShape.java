 ...
 * @author ouyubin
 */
public class CompileFlowScriptShape extends Shape {


    public CompileFlowScriptShape(@NotNull Object value) {
        super(value);
    }
    ...
    public void paintShape(mxGraphics2DCanvas canvas, mxCellState state) {
        ...
        if (model instanceof XmlTagModelElement) {
            ...
            if (xmlTag.isValid())
                id = xmlTag.getAttributeValue(NAME_ATTR_NAME)==null?"脚本":xmlTag.getAttributeValue(NAME_ATTR_NAME);
            ...
            ImageIcon imageIcon = CompileFlowImages.SCRIPT_IMAGE();
