...
import cn.shanghai.oyb.compileflow.editor.CompileFlowClassFileEditor;
 ...
 * @author ouyubin
 */
public class CompileFlowClassFileEditorProvider extends AbstractGraphFileEditorProvider {
...
//        EditorImpl editor = ObjectUtils.tryCast(FileEditorManager.getInstance(project).getSelectedTextEditor(), EditorImpl.class);
//        editor.get
...
//        providers.
//        return editor;
        return new CompileFlowClassFileEditor(project,file);
    }
