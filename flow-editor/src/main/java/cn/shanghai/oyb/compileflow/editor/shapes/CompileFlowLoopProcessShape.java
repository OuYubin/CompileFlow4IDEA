 ...
 * @author ouyubin
 */
public class CompileFlowLoopProcessShape extends Shape {


    public CompileFlowLoopProcessShape(@NotNull Object value) {
        super(value);
    }
    ...
    public void paintShape(mxGraphics2DCanvas canvas, mxCellState state) {
        ...
        gc.setColor(new JBColor(new Color(175, 176, 179), JBColor.white));
        gc.setStroke(basicStroke);
        int shadowWidth = 2;

        JBColor base = new JBColor(new Color(210, 245, 245), new Color(210, 245, 245));
        gc.setColor(base);
        ...
        Color[] colors = {new Color(210, 245, 245), Color.WHITE};
        ...
        if (!UIUtil.isUnderDarcula()) {
            ...
            gc.setColor(new JBColor(new Color(210, 245, 245), JBColor.DARK_GRAY));
        ...
        if (model instanceof XmlTagModelElement) {
            ...
            id = xmlTag.getAttributeValue(NAME_ATTR_NAME)==null?"循环":xmlTag.getAttributeValue(NAME_ATTR_NAME);
        }

        FontMetrics fontMetrics = gc.getFontMetrics();
        ImageIcon imageIcon = new ImageIcon(CompileFlowSvgImages.LOOP_IMAGE);
        ...
        gc.drawImage(imageIcon.getImage(), positionX, y + shadowWidth+5, 16, 16, null);
        gc.setColor(new JBColor(Color.BLACK, Color.WHITE));
        gc.drawString(id, positionX + imageIcon.getIconWidth() + 5, y  + imageIcon.getIconHeight() - shadowWidth+5);
