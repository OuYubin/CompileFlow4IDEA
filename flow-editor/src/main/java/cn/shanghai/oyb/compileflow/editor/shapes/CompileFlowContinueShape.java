 ...
 * @author ouyubin
 */
public class CompileFlowContinueShape extends Shape {


    public CompileFlowContinueShape(@NotNull Object value) {
        super(value);
    }
    ...
    public void paintShape(mxGraphics2DCanvas canvas, mxCellState state) {
        ...
        if (model instanceof XmlTagModelElement) {
            ...
            id = xmlTag.getAttributeValue(NAME_ATTR_NAME)==null?"继续":xmlTag.getAttributeValue(NAME_ATTR_NAME);
        }

        FontMetrics fontMetrics = gc.getFontMetrics();
        ImageIcon imageIcon = CompileFlowImages.CONTINUE_IMAGE();
