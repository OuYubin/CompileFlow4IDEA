...
import cn.shanghai.oyb.compileflow.editor.cells.CompileFlowScriptCell;
 ...
 * @author ouyubin
 */
public class CompileFlowScriptGraphEditPart extends CompileFlowElementEditPart {

    public CompileFlowScriptGraphEditPart(Object model, TAdaptable adapter) {
        super(model, adapter);
    }

    @Override
    public BaseCell createCell(Geometry geometry) {
        CompileFlowScriptCell compileFlowScriptCell = new CompileFlowScriptCell(getModel(), geometry);
        return compileFlowScriptCell;
    }
