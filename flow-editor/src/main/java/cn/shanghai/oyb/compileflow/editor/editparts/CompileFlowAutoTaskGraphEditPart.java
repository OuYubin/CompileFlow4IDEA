...
import cn.shanghai.oyb.compileflow.editor.cells.CompileFlowAutoTaskCell;
 ...
 * @author ouyubin
 */
public class CompileFlowAutoTaskGraphEditPart extends CompileFlowElementEditPart {

    public CompileFlowAutoTaskGraphEditPart(Object model, TAdaptable adapter) {
        super(model, adapter);
    }
    ...
    public BaseCell createCell(Geometry geometry) {
        ...
        CompileFlowAutoTaskCell compileFlowAutoCell = new CompileFlowAutoTaskCell(getModel(), geometry);
        return compileFlowAutoCell;
    }
    ...
    public BaseGeometry createGeometry() {
        ...
        int y = 0;
        //-设置初始大小
        double width = CompileFlowGeometryConstants.AUTO_TASK_GEOMETRY[0];
        double height = CompileFlowGeometryConstants.AUTO_TASK_GEOMETRY[1];
