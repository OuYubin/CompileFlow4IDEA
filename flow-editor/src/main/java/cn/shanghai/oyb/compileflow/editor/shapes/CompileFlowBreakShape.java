 ...
 * @author ouyubin
 */
public class CompileFlowBreakShape extends Shape {


    public CompileFlowBreakShape(@NotNull Object value) {
        super(value);
    }
    ...
    public void paintShape(mxGraphics2DCanvas canvas, mxCellState state) {
        ...
        if (model instanceof XmlTagModelElement) {
            ...
            id = xmlTag.getAttributeValue(NAME_ATTR_NAME)==null?"中止":xmlTag.getAttributeValue(NAME_ATTR_NAME);
        }

        FontMetrics fontMetrics = gc.getFontMetrics();
        ImageIcon imageIcon = new ImageIcon(CompileFlowSvgImages.BREAK_IMAGE);
